...
//	//d2e = mp.vol * d2e;
//	real Dp_inv = 3.0;
//	d2e = mp.vol * wxixp * wxjxp * Dp_inv * Dp_inv * d2e;
//}
//
...
//			size_t index = i * grid.grid_dim_y + j;
...
//	for (int i = 0; i < gridDegreesOfFreedom.size(); i++) {
//		int index = gridDegreesOfFreedom[i].x * int(grid.grid_dim_y) + gridDegreesOfFreedom[i].y;
...
//		int index = gridDegreesOfFreedom[i].x * grid.grid_dim_y + gridDegreesOfFreedom[i].y;
